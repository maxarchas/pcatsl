...
All the Terraform code for this module is defined in [infrastructure-modules-multi-account-acme/security/kms-master-key](https://github.com/gruntwork-io/infrastructure-modules-multi-account-acme/tree/master/security/kms-master-key).
...
For more info, check out the Readme for this module in [infrastructure-modules-multi-account-acme/security/kms-master-key](https://github.com/gruntwork-io/infrastructure-modules-multi-account-acme/tree/master/security/kms-master-key).