...
1. **Mysql**: Mysql is deployed using [Amazon's Relational Database Service 
...
* **Security updates**: see the [auto-update module](https://github.com/maxar-infrastructure/module-security/tree/master/modules/auto-update).
