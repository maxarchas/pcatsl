...
This directory configures the [AWS Account Password Policy](
...
All the Terraform code for this module is defined in [infrastructure-modules-multi-account-acme/security/iam-user-password-policy](https://github.com/gruntwork-io/infrastructure-modules-multi-account-acme/tree/master/security/iam-user-password-policy).
...
For more info, check out the Readme for this module in [infrastructure-modules-multi-account-acme/security/iam-user-password-policy](https://github.com/gruntwork-io/infrastructure-modules-multi-account-acme/tree/master/security/iam-user-password-policy).